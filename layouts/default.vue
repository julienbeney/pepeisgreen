<template>
    ...
    <div style="z-index: 90" class="modal bg-white p-8 rounded-lg shadow-md">
    ...
    <div style="z-index: 100" class="page-display fixed inset-x-0 inset-y-0 bg-gray-400 m-10 p-5 p-0-sm rounded-tl-lg rounded-tr-lg rounded-bl-lg rounded-br-lg shadow-md">
